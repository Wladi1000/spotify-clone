  ...
  <div>
      ...
      >
        <div class="flex items-center">
          <img 
            class="rounded-full"
            width="27"
            src="https://yt3.ggpht.com/yti/AHXOFjVAk9E5Jy6Z6GVY5hU1pzb0zumlSSrLc6w9udZzww=s108-c-k-c0x00ffffff-no-rj"
          >
          <div class="text-white text-[14px] ml-1.5 font-semibold">Wladimir Sanvicente</div>
    ...
    >
      ...
      <ul>
        ...
        <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist #5</li>
      </ul>
    </div>
  </div>
